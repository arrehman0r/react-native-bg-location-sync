# 🚛 Truck Tracker - Real-time GPS Tracking that work even on app kill from recetnt apps

A production-ready React Native application for real-time truck location tracking with offline support, automatic data synchronization, and comprehensive geolocation management for fleet operations that works on even on app kill from recent apps
